...
# Experiment settings
EXP_NAME = "ant_30_home"
LOCATION = "HOME" #"FEL"
START_TIME = None
VALIDATION_DATA_SETS = ["b200_28th_night", "b200_30_office", "ant_30_home", "val06", "val07", "val08", "val09", "val10"]
...
class DEBUG:
    ...
    plot_residuals = False  # Plot residuals per satellite to identify ghost satellites
